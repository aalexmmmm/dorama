"""
Django settings for aalexmmmm project.
...
WSGI_APPLICATION = 'aalexmmmm.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'aalexmmmm_cache'),
    }
}